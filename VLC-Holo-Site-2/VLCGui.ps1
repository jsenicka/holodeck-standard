...
Function cbConfigurator
{
    ...
    Param (
        ...
        [Net.IPAddress]$DhcpIPSubnet = "172.26.254.0",
        [INT]$DhcpSubnetCIDR = "24",
        [Net.IPAddress]$DhcpGateway = "172.26.254.1",
        [parameter(Mandatory=$true)]
...
#NFS and other service config
    ...
    $replaceDNS +="echo recursive_acl = \`"10.0.0.0/24,$DhcpIPSubnet/$DhcpSubnetCIDR,$($nsxSuperNet),$CloudBuilderIPSubnet/$CloudBuilderCIDR,$($avnNets[0]),$($avnNets[1]),$($tzEgress),$($tzIngress)\`"`n"
